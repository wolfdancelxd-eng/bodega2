...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['ajax_agregar'])) {
    ...
    // Lista de todos los stocks iniciales correspondientes a cada ID del catálogo
    $stocks_iniciales = [
        '1' => 45,  // Arroz Costeño
        '2' => 30,  // Aceite Primor
        '3' => 60,  // Azúcar Blanca
        '4' => 80,  // Fideos Don Vittorio
        '5' => 120, // Coca Cola 2L
        '6' => 90,  // Inca Kola 1.5L
        '7' => 150, // Agua San Luis
        '8' => 75,  // Gaseosa Sprite
        '9' => 55,  // Leche Gloria
        '10' => 40, // Queso Fresco
        '11' => 25, // Mantequilla Laive
        '12' => 35, // Yogurt Gloria
        '13' => 40, // Detergente Ariel
        '14' => 60, // Lejía Clorox
        '15' => 80, // Esponja Scotch-Brite
        '16' => 45, // Lava Vajillas Sapolio
        '17' => 60, // Galletas Oreo
        '18' => 50, // Papas Lay's
        '19' => 35, // Sublime
        '20' => 70  // Chancay x6
    ...
    // Sumamos el total de ítems en carrito para el header
    ...
    <div class="catalog-header">
        ...
        <div class="catalog-grid" id="catalog-grid">
            ...
            <div class="product-card" data-cat="Abarrotes">
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Abarrotes</span>
            ...
            <div class="product-card" data-cat="Abarrotes">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_2 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_2; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Abarrotes</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_2 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_2 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Abarrotes">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_4 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_4; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Abarrotes</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_4 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_4 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Bebidas">
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Bebidas</span>
            ...
            <div class="product-card" data-cat="Bebidas">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_6 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_6; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Bebidas</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_6 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_6 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Bebidas">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_7 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_7; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Bebidas</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_7 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_7 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Bebidas">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_8 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_8; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Bebidas</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_8 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_8 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Lácteos">
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Lácteos</span>
            ...
            <div class="product-card" data-cat="Lácteos">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_10 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_10; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Lácteos</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_10 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_10 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Lácteos">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_11 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_11; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Lácteos</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_11 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_11 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Lácteos">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_12 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_12; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Lácteos</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_12 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_12 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
                ...
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_13 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_13; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                </div>
                <form class="product-body form-agregar-carrito"><span class="product-category">Limpieza</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_13 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_13 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Limpieza">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_14 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_14; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Limpieza</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_14 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_14 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Limpieza">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_15 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_15; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Limpieza</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_15 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_15 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Limpieza">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_16 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_16; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Limpieza</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_16 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_16 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
                ...
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_17 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_17; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                </div>
                <form class="product-body form-agregar-carrito"><span class="product-category">Snacks</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_17 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_17 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Snacks">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_18 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_18; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Snacks</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_18 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_18 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Snacks">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_19 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_19; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Snacks</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_19 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_19 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
            ...
            <div class="product-card" data-cat="Snacks">
                <div class="product-img">
                    ...
                    <span class="stock-badge js-stock-label">
                        <?php if ($stock_final_20 > 0): ?>
                            <img src="img/Cardboard Box.png" alt=""> <span class="stock-numero"><?php echo $stock_final_20; ?></span> disponibles
                        <?php else: ?>
                            <span class="badge-agotado" style="color: #ff4d4d; font-weight: bold;">Agotado</span>
                        <?php endif; ?>
                    </span>
                ...
                <form class="product-body form-agregar-carrito"><span class="product-category">Snacks</span>
                    ...
                    <button type="submit" class="btn-add-cart js-btn-submit" <?php echo ($stock_final_20 <= 0) ? 'disabled style="background-color: #ccc; cursor: not-allowed;"' : ''; ?>>
                        <?php echo ($stock_final_20 > 0) ? '<img src="img/Shopping Cart.png" alt=""> Agregar al Carrito' : 'Agotado'; ?>
                    </button>
                </form>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formularios.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            formData.append('ajax_agregar', 'true'); // PHP procesará esto sin recargar
            ...
            .then(data => {
                if (data.success) {
                    // 1. Mostrar el hermoso Toast dinámico apilable en la esquina
                    crearToast(data.nombre);

                    // 2. Modificación QUIRÚRGICA: Solo cambia el número de stock del producto actual
                    ...
                    if (data.nuevo_stock > 0) {
                        if (tagNumeroStock) {
                            tagNumeroStock.textContent = data.nuevo_stock; // Cambia el número sin tocar la imagen (0 pestañeos)
                        }
                    } else {
                        // Si se agota, transformamos el badge a Agotado
                        ...
                        // Modificar comportamiento del botón de agregar
                    ...
                    // 3. Actualizar contador del header dinámicamente si existe en tu plantilla
